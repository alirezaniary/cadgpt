...
| [0031](DEC-0031-tread-length-and-exit-width-conventions.md) | `TreadLength_AtWalkingLine` and `ExitWidth_Narrowest`; IFC's own distinction inherited | Lead | DECIDED |
