...
- Add `publish-corpus` and `corpus-check`. They consume re-attested T-0103 validation, T-0102
  extraction, T-0101 structure, T-0100 transcription, T-0099 acquisition, and catalog receipts.
