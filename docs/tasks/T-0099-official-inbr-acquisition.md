# T-0099 — Acquire and attest the official INBR corpus
...
T-0098 pins the bytes already present locally, but the corpus cannot yet be reproduced from
...
items remain outside T-0099's fix-now scope.
